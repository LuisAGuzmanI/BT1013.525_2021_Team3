...
Timinas <- c(zikaComposition[4], sarsComposition[4], wuhan1Composition[4], dengueComposition[4], h1n1Composition[4])
...
graphic <- ggplot(dfCompositions, aes(Virus, Nucleotidos), group = nomVirus) + 
  ...
  geom_line(linetype="dashed", y = Timinas, color = 'black', size = 1)
